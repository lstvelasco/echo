...
@if (Auth::user()->account_type == 'Project Manager' || Auth::user()->account_type == 'Event Organizer')
    <x-application-shell>
        <x-ui.post-card>
                        ...
                        <table class="w-full h-full text-sm text-left text-gray-500 dark:text-gray-400">
                            <thead
                                ...
                                <tr>
                                    ...
                                    <th scope="col" class="px-4 py-3">Applicant Name</th>
                            ...
                            <tbody>
                                @foreach ($applications as $application)
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-3">{{ $application->event->name }}</td>
                                        <td class="px-4 py-3"><a href="/portfolio/{{ $application->applicant_id }}" target="_blank">Check</a></td>
                                        <td class="px-4 py-3">{{ $application->created_at }}</td>
                                        <td class="px-4 py-3">{{ $application->status }}</td>
                                        <td class="flex items-center justify-end px-4 py-3">
                                            <button id="{{ $application->id }}-dropdown-button"
                                                data-dropdown-toggle="{{ $application->id }}-dropdown"
                                            ...
                                            <div id="{{ $application->id }}-dropdown"
                                                class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                    aria-labelledby="{{ $application->id }}-dropdown-button">
                                                    <li>
                                                        <a href="#" id="{{ $application->id }}ApproveButton"
                                                            data-modal-target="{{ $application->id }}ApproveModal"
                                                            data-modal-toggle="{{ $application->id }}ApproveModal"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Approve</a>
                                                    </li>
                                                    <li>
                                                        <a href="#" id="{{ $application->id }}RejectButton"
                                                            data-modal-target="{{ $application->id }}RejectModal"
                                                            data-modal-toggle="{{ $application->id }}RejectModal"
                                    ...
                                    <x-application.modal name="{{ $application->id }}Approve" inputId1="application_id"
                                        inputId2="applicant_id" data1="{{ $application->id }}" data2="{{ $application->applicant_id }}" cancelMessage="No, cancel"
                                    ...
                                    <x-application.modal name="{{ $application->id }}Reject" inputId1="application_id"
                                        inputId2="applicant_id" data1="{{ $application->id }}" data2="{{ $application->applicant_id }}" cancelMessage="No, cancel"
...
@elseif (Auth::user()->account_type == 'Photographer' || Auth::user()->account_type == 'Model')
    <x-application-shell>
        <x-ui.post-card>
            <div class="w-full min-h-[61vh] md:min-h-[65vh] mx-auto ">
                <!-- Start coding here -->
                <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto min-h-[61vh] md:min-h-[65vh]">
                        <table class="w-full h-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                @foreach ($applications->where('applicant_id', Auth::id()) as $application)
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            {{ $application->id }}</th>
                                        ...
                                        {{-- <td class="flex items-center justify-end px-4 py-3">
                                            ...
                                            <div id="{{ $application->id }}-dropdown"
                                                ...
                                                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                    aria-labelledby="{{ $application->id }}-dropdown-button">
                                                    <li>
                                                        <a id="ApproveButton" data-modal-target="ApproveModal"
