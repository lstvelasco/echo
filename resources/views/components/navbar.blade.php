    ...
    <div class="flex flex-wrap items-center justify-between">
        <div class="flex items-center justify-start">
            ...
            <a href="#" class="flex items-center justify-between mr-4">
                <img src="{{ Vite::asset('resources/images/logo.svg') }}" class="h-8 mr-3" alt="Echo Logo" />
                <span
                    class="self-center hidden text-2xl font-semibold sm:block whitespace-nowrap dark:text-white">Echo</span>
            </a>
